...
namespace LMS.Modules.Membership.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250618193008_AddedAuditingPropertiesToOutboxTable")]
    partial class AddedAuditingPropertiesToOutboxTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMS.Common.Infrastructrure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("outbox_messages", "membership");
                });
                    ...
                    b.ToTable("patrons", "membership", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_patrons_onboarding_stage", "onboarding_stage in ('PatronAdded', 'AddressAdded', 'DocumentAdded', 'DocumentsVerified', 'Completed')");
