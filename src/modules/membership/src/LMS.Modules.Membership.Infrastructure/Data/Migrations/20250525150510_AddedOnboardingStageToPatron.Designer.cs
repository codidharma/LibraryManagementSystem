...
namespace LMS.Modules.Membership.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250525150510_AddedOnboardingStageToPatron")]
    partial class AddedOnboardingStageToPatron
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("patrons", "membership", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_patrons_onboarding_stage", "onboarding_stage in ('PatronAdded', 'AddressAdded', 'DocumentAdded', 'DocumentsVerified')");
