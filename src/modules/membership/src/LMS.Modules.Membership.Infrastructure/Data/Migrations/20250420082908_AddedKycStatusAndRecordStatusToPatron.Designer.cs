...
namespace LMS.Modules.Membership.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250420082908_AddedKycStatusAndRecordStatusToPatron")]
    partial class AddedKycStatusAndRecordStatusToPatron
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LMS.Modules.Membership.Domain.PatronAggregate.Patron", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Address", "LMS.Modules.Membership.Domain.PatronAggregate.Patron.Address#Address", b1 =>
                        {
                            b1.IsRequired();
